...
//		gridBagLayout.rowWeights = new double[]{Double.MIN_VALUE};
		...
		jtfNota.setText(ValoracionMateriaController.notaEstudianteMateriaProfesor(this.estudiante, this.profesor,
				this.materia) != null
						? "" + ValoracionMateriaController
								.notaEstudianteMateriaProfesor(this.estudiante, this.profesor, this.materia)
								.getValoracion()
						: "");
	...
	public Valoracionmateria guardar() {
		...
		Valoracionmateria m = ValoracionMateriaController.notaEstudianteMateriaProfesor(this.estudiante, this.profesor,
				this.materia);
		if (m != null) {
			vm.setId(m.getId());
		}
	...
	public String toString() {
		return estudiante.getNombre() + " " + materia.getNombre() + " " + profesor.getNombre();
	}
